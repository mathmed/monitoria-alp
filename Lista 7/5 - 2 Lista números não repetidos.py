...
#10 elementos, e armazene-os em duas listas A e B. Em seguida, o programa deverá
#construir o conjunto UNIÃO, que representa a união das listas A e B. Lembre-se que
#conjuntos não devem possuir elementos repetidos.
lista1=[]
cont1=0
while cont1 <10:
